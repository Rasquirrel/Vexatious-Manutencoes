                  ...
                  <div class="col-lg-12">
                    <div class="card py-4 my-4">
                      <div class="card-header">
                        <h3 class="h4 mb-0">Cadastro de clientes</h3>
                      </div>
                      <div class="card-body pt-0">
                        <form class="form-horizontal" action="javascript:" method="POST">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="date" required id="nascimento">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="text" required id="telefone">
                            </div>
                          </div>
